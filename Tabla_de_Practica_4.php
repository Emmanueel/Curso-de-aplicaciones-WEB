...
<head>
    ...
    <title>Tabla de Formulario_Equipo</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="C:\Users\Emanuel\Curso-de-aplicaciones-WEB\Sistema\Views/Practica-4.html">Formulario_Equipo</a>
            </li>
      ...
      <div class="container">
    <h1>Tala de Formularios_Equipo</h1>
    <table class="table table-dark" border="1">
        <tr><th colspan="2">Tabla Equipo</th><tr>
        <tr>
            <td>ID_Equipo</td>
            <td>Nombre</td>
            <td>Precio</td>
