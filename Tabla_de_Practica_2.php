...
<head>
    ...
    <title>Tabla de Formulario_Registro</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="C:\Users\Emanuel\Curso-de-aplicaciones-WEB\Sistema\Views/Practica-2.html">Formulario_Registro</a>
            </li>
      ...
      <div class="container">
    <h1>Tabla de Formularios_Registro</h1>
    <table class="table table-dark" border="1">
        <tr><th colspan="10">Tabla Registro</th></tr>
        <tr>
            <td>ID_Registro</td>
        ...
        <tbody>
                  ...
                  <td><?php echo $registro["Fecha_de_Registro"] ?></td>
